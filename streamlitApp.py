...
st.markdown(
    "**Aim**: This notebook presents interactive Sankey diagrams of iron and steel flows for the world's top 30 crude steel producing countries.")
st.markdown(
...
st.markdown("**-** Hover for details: Hover over each flow in the graph to see the actual data.")

available_years = [2000, 2005, 2010, 2015, 2019]
year = st.slider('Year', min_value=min(available_years), max_value=max(available_years), step=1)
